...
# Load data
dataset_folder = r'C:\Users\Umt\Desktop\WV_scenarios\Scenario 1'
data_path = r'C:\Users\Umt\Documents\GitHub\DeepSense-synth\Generator\application\output.mat'
...
dropout = 0.2
kernel_size = (3, 3)
input_img_o = tf.keras.layers.Input(shape=(1920, 720, 3))
...
model_image2 = tf.keras.models.Model(inputs=input_img_o, outputs=img_out)
model_image3 = tf.keras.models.Model(inputs=input_img_o, outputs=img_out)

#%%
input_img1 = tf.keras.layers.Input(shape=(1920, 720, 3))
input_img2 = tf.keras.layers.Input(shape=(1920, 720, 3))
input_img3 = tf.keras.layers.Input(shape=(1920, 720, 3))
...
x_out = tf.keras.layers.Dense(n_beams, activation='sigmoid')(x_in)
