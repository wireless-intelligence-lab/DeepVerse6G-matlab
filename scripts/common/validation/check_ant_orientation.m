function params_inner = check_ant_orientation(params, params_inner, array_rot_act_str, array_rot_str, active_bs_str)
    if params.(array_rot_act_str)
        ...
        params_inner.(array_rot_str) = zeros(params.(active_bs_str),3);
    end
end
