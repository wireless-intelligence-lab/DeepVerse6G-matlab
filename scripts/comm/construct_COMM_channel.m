...
function [channel, channel_LoS_status, path_params] = construct_COMM_channel(tx_ant_size, tx_rotation, tx_FoV, tx_ant_spacing, rx_ant_size, rx_rotation, rx_FoV, rx_ant_spacing, path_params, params, params_inner)
