...
% Active users
params.num_active_users = 5;        % Number of active users
% params.active_user_first = 3;       % The first row of the considered user section (check the scenario description for the user row map)
% params.active_user_last = 5;        % The last row of the considered user section (check the scenario description for the user row map)
